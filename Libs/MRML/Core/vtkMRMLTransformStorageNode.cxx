...
template <typename T> bool SetVTKBSplineFromITK(vtkObject* self, vtkITKBSplineTransform* bsplineVtk, TransformType::Pointer bsplineItk, TransformType::Pointer bulkItk)
{
  ...
  BSplineTransformType::Pointer bst = dynamic_cast< BSplineTransformType* >( bsplineItk.GetPointer() );
  if (!bst)
    {
    return false;
    }
  ...
  BSplineTransformType::ParametersType const& param = bst->GetParameters();
