...
/// or what they contain. Each 4D "layer" in the image can contain many segments.
...
/// - SegmentN_Layer: The 4D dimension that contains the segment. For Segmentations in which the segments do not overlap, the segmentation can
