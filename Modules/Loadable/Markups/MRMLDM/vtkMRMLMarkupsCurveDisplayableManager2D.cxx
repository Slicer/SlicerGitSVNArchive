...
//---------------------------------------------------------------------------
vtkSlicerAbstractWidget * vtkMRMLMarkupsCurveDisplayableManager2D::CreateWidget(vtkMRMLMarkupsNode* node)
{
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkMRMLMarkupsCurveDisplayableManager2D::OnWidgetCreated(vtkSlicerAbstractWidget * widget, vtkMRMLMarkupsNode * node)
{
  if (!widget)
    {
...
//---------------------------------------------------------------------------
void vtkMRMLMarkupsCurveDisplayableManager2D::OnClickInRenderWindow(double x, double y,
                                                                    ...
                                                                    int action /*= 0 */)
{
  ...
  if (action == vtkMRMLMarkupsCurveDisplayableManager2D::AddPoint)
    {
  ...
  else if (action == vtkMRMLMarkupsCurveDisplayableManager2D::AddPreview)
    {
  ...
  else if (action == vtkMRMLMarkupsCurveDisplayableManager2D::RemovePreview)
    {
