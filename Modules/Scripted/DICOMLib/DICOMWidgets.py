...
class DICOMLoadableTable(qt.QTableWidget):
  ...
  def configure(self):
    ...
    self.horizontalHeader(qt.QHeaderView.Stretch)
    self.horizontalHeader(0, qt.QHeaderView.ResizeToContents)
    self.horizontalHeader(1, qt.QHeaderView.Stretch)
    self.horizontalHeader(2, qt.QHeaderView.Stretch)
